 ...
 */
define(['N/file', 'N/record', 'N/search', 'N/runtime', 'N/email', 'N/https', "./Lib/rxrs_lib_return_request_util"],
    /**
     * @param{file} file
     * @param{record} record
     * @param search
    ...
    (file, record, search, runtime, email, https, rxrsUtil) => {
        ...
        const afterSubmit = (context) => {
            ...
            if (context.type === context.UserEventType.CREATE) {
                ...
                const totalNumberOfLabels = rrCategory.reduce((sum, {numOfLabels}) => sum + numOfLabels, 0)

  ...
  function generatePdf(context) {
    try {
      ...
      try {
        ...
        var rrType = getReturnRequestType(rId);
        var lookupRs = search.lookupFields({
          type: rrType,
          id: rId,
        ...
        if (searchResultCount > 0 && searchResultCount == form222FileCount) {
          ...
          if (isTrackingNumberGenerated == true) {
            ...
            if (rrRec.getValue("transtatus") == rrStatus.C2Kittobemailed) {
              ...
              try {
                record.submitFields({
                  ...
                  id: rrId,
                  values: {
                    transtatus: rrStatus.PendingPackageReceipt,
                  },
                });
              } catch (e) {

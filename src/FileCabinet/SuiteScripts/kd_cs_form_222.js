 ...
 */ function (record, url, currentRecord, search) {
  ...
  function createItemRequested() {
    ...
    try {
      ...
      var mrrIdSearch;
      var rrType = getReturnRequestType(returnRequestId)
      ...
      var obj = [form222Id, returnRequestId, mrrIdSearch];
      console.log(mrrIdSearch);
  ...
  function validateLine(context) {
    try {
      ...
      console.error("validateLine", e.message);
    }
  }
  ...
  function createMultipleRir(id, masterReturn) {
    try {
      ...
      log.error("createMultipleRir", e.message);
    }
  }
